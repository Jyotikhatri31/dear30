  ...
  return (
    <Box sx={{backgroundColor: '#000'}}>
      <Container maxWidth={false} className="container ">
        <Box className="center-content" sx={{flexDirection: 'column',  minHeight: '75vh', color: '#fff'}}>
          <CheckCircleIcon sx={{fontSize: '10rem', color: '#5FEF45'}}/>
          <Typography sx={{color: '#5FEF45', fontSize: '1.8rem', mt: 2}}>Your order was successful</Typography>
          <Typography sx={{fontSize: '2.8rem', my: 2}}>Thanks for your purchase!</Typography>
